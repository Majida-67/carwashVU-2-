...
$total_feedbacks_query = "SELECT COUNT(*) AS total FROM feedback WHERE user_id = '$employee_id'";
$total_feedbacks = mysqli_fetch_assoc(mysqli_query($conn, $total_feedbacks_query))['total'] ?? 0;
?>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="employee_bookings.php">Bookings</a></li>
                    <li class="nav-item"><a class="nav-link" href="view_feedback.php">Customer Feedbacks</a></li>
                </ul>
            </div>
        </div>
    </nav>
